...
namespace Ex03.ConsoleUI
{
    internal class InputValidation
    {
        ...
        internal static bool IsValidEnumInput(string i_UserInput, int i_EnumLength, out int i_ValidUserInput)
        {
        ...
        internal static bool IsValidEngineVolume(string i_EngineVolume, out int i_ValidEngineVolume)
        {
        ...
        internal static bool IsValidDangerousMaterialsInput(string i_IsDangerous, out bool i_DangerousMaterials)
        {
            int isDangerous;
        ...
        internal static bool IsValidFloatInput(string i_UnerInput, out float o_ValidFloat)
        {
        ...
        internal static bool isZeroChar(char i_UserInput)
        {
            return i_UserInput.Equals(k_ZeroChar);
        }
    }
}
